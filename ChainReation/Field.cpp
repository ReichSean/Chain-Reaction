...
#include <string>
#include <random>
#include <chrono>  // F�r system_clock
...
public:
    ...
    // Zuf�llige ID, die im Konstruktor des Spielers erstellt wird
...
public:
    ...
    const Feld& getFeld() const {
        return *this; // Gibt eine konstante Referenz auf das aktuelle Objekt zur�ck
    }
    */
